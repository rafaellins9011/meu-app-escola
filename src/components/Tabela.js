...
const Tabela = ({
    ...
    onAbrirModalFoto, // Função para abrir o CameraModal
    onViewPhoto,
    onExcluirFoto,
    onToggleAllChamada
}) => {
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4 text-sm">
                                        <div className="flex flex-nowrap gap-2" onClick={(e) => e.stopPropagation()}>
                                            {/* O botão "Tirar Foto" ou "Excluir Foto" agora abre o CameraModal no modo correto */}
                                            {aluno.fotoUrl ? (
                                                <>
                                                    <button
                                                        onClick={() => onAbrirModalFoto(aluno)} // Abre para edição
                                                ...
                                                <button
                                                    onClick={() => onAbrirModalFoto(aluno)} // Abre para tirar foto
                                                    className="px-3 py-1 rounded-lg bg-purple-500 text-white text-xs hover:bg-purple-600 transition-colors duration-200 shadow-sm"
                                                    title="Tirar Foto"
                                                >
                                                    📸
